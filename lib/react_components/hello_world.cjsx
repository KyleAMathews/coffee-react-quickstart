  ...
  render: ->
    <div>
      ...
      <ul>
        ...
        <li>Uses Gulp for building CSS and Javascript. Run <code>cult watch</code> for rebuilding css/js on the fly while developing and <code>cult build</code> to create minified versions to deploy to production.</li>
